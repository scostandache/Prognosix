...
<header class="main_header">
    <a href= <?php if($_SESSION['admin']==0) echo "../profile_page/home.php" ;
                                else echo "../admin/admin_dash.php "?>        >
                    <div class="logo">
...
<h1 class="reset_pass">Resetare parola </h1>
    ...
    <div style="width:500px;">
        ...
        <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
            ...
            <tr>
                ...
                <td width="60%"><input type="password" name="currentPassword" class="txtField"/><span
