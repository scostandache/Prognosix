<?php
    ...
    {
        if ($tip != "examen" and $tip != "laborator") {
            echo "Tipul trebuie sa fie examen sau laborator";
        }
        else
        {
            if (DateTime::createFromFormat('d-m-Y', $dataInceput) == FALSE || DateTime::createFromFormat('d-m-Y', $dataSfarsit) == FALSE) {
                ...
                $sql = "SELECT id_exam FROM examene WHERE nume_obiect = '" . $obiect . "' and tip = '" . $tip . "'";
                //echo $sql;
